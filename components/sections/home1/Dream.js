  ...
  return (
    <section className="dream-section p_relative">
      <div
        ...
        data-parallax='{"y": 100}'
        style={{
          backgroundImage: "url(assets/images/background/dream-bg.jpg)",
        }}
      ></div>
      <div
          ...
          <div className="content-box p_relative d_block">
            ...
            <div className="text mb_25">
              <p>
                ...
                happiness come from? Explain to me how this erroneous theory
                ended up being devised.
              </p>
            </div>
            <ul className="list-item p_relative clearfix">
              <li>
                <Link href="/">
                  1. Entering & Leaving From Country <i className="icon-9"></i>
                </Link>
              </li>
              <li>
                <Link href="/">

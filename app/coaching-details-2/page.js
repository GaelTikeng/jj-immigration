...
export default function Home() {
  ...
  const handleOnClick = (index) => {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={3} breadcrumbTitle="PTE Coaching">
                        ...
                        <div className="coaching-sidebar default-sidebar">
                            <div className="sidebar-widget category-widget">
                                <ul className="category-list clearfix">
                                    ...
                                    <li><Link href="coaching-details-2" className="current">PTE Coaching</Link></li>
                            ...
                            <div className="upper-box mb_40">
                                ...
                                <div className="text-box mb_40">
                                    ...
                                    <ul className="clearfix">
                                        <li><Link href="coaching-details-2"><span>1</span>Immigrate</Link></li>
                                        <li><Link href="coaching-details-2"><span>2</span>Work</Link></li>
                                        <li><Link href="coaching-details-2"><span>3</span>Study</Link></li>
                                        <li><Link href="coaching-details-2"><span>4</span>Citizenship</Link></li>
                                    </ul>
                                </div>
                                <figure className="image-box"><img src="assets/images/resource/coaching-16.jpg" alt="" /></figure>
                            </div>
                                                        ...
                                                        <div className="single-item">
                                                            ...
                                                            <div className="lower-content">
                                                                ...
                                                                <div className="btn-box">
                                                                    <Link href="coaching-details-2"><span className="price">$105.99</span><span className="text">Get Started</span></Link>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

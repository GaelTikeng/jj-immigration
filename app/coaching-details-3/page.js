...
export default function Home() {
  ...
  return (
    <>
      <Layout headerStyle={1} footerStyle={3} breadcrumbTitle="OET Coaching">
                ...
                <div className="coaching-sidebar default-sidebar">
                  <div className="sidebar-widget category-widget">
                    <ul className="category-list clearfix">
                      ...
                      <li>
                        <Link href="coaching-details-3" className="current">
                          OET Coaching
                        </Link>
                      </li>
                      <li>
                  ...
                  <div className="upper-box mb_40">
                    ...
                    <div className="text-box mb_40">
                      <p>
                        ...
                        rutrum.Porta semper lacus cursus, feugiat primis ultrice
                        and ligula risus auctor tempus feugiat dolor and
                        lacinia.Vivamus ac ultricies ex. Donec lacinia lacus
                        libero.
                      </p>
                      <ul className="clearfix">
                        <li>
                          <Link href="coaching-details-3">
                            <span>1</span>Immigrate
                          </Link>
                        </li>
                        <li>
                          <Link href="coaching-details-3">
                    ...
                    <figure className="image-box">
                      <img
                        src="assets/images/resource/coaching-17.jpg"
                        alt=""
                      />
                    </figure>
                  </div>
                          ...
                          <div className="content-one mb_40">
                            <div className="row align-items-center">
                              <div className="col-lg-7 col-md-6 col-sm-12 text-column">
                                <div className="text">
                                  <h3>
                                    Morente reiterates rule on proper wearing of
                                    uniform
                                  </h3>
                                  <p>
                                    In a memorandum issued on Wednesday, Morente
                                    stated that the BI has been receiving
                                    complaints about officials and employees who
                                    are not wearing their complete uniform
                                    during their tour of duty.
                                  </p>
                                  <p>
                                    “+Our immigration officers and employees are
                                    expected to be in their complete uniform,{" "}
                                    <br />
                                    with their nameplates and IDs,” said
                                    Morente. “We have a BI CARES project that
                                    reinforces our commitment to better public
                                    service,” he added. The BI CARES project
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="text mt_20">
                              <p>
                                stands for courtesy, accountability,
                                responsibility, efficiency and service. “It is
                                high time that law enforcement be
                                professionalized,” said Morente. “We can
                                implement our laws and policies, but as public
                                servants, we are also expected to be courteous
                                and responsible,” he added.
                              </p>
                            </div>
                          </div>
                                ...
                                <div className="single-item">
                                  ...
                                  <div className="lower-content">
                                    ...
                                    <div className="btn-box">
                                      <Link href="coaching-details-3">
                                        <span className="price">$105.99</span>
                                        <span className="text">
                                          Get Started
                                        </span>
                                      </Link>
                            ...
                            <div className="row clearfix">
                              ...
                              <div className="col-lg-5 col-md-6 col-sm-12 content-column">
                                <div className="content-inner">
                                  <figure className="image-box">
                                    <img
                                      src="assets/images/resource/coaching-15.jpg"
                                      alt=""
                                    />
                                  </figure>
                                  <div className="text">
                                    ...
                                    <p>
                                      In a memorandum issued on Wednesday,
                                      Morente stated that the BI has been
                                      receiving complaints about officials and
                                      employees who are not wearing their
                                      complete uniform during their tour of
                                      duty.
                                    </p>
                                  </div>
                                </div>

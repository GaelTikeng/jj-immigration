  ...
  return (
    <>
      <Layout
        headerStyle={1}
        footerStyle={3}
        breadcrumbTitle="Spouse/Family Visas"
      >
                ...
                <div className="visa-sidebar default-sidebar">
                  <div className="sidebar-widget category-widget">
                    <ul className="category-list clearfix">
                      ...
                      <li>
                        <Link href="visa-details-5" className="current">
                          Spouse/Family Visas
                        </Link>
                      </li>
                      <li>
              ...
              <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                <div className="visa-details-content">
                  <div className="content-one mb_60">
                    ...
                    <figure className="image-box">
                      <img src="assets/images/resource/visa-18.jpg" alt="" />
                    </figure>
                    ...
                    <div className="row clearfix">
                      <div className="col-lg-6 col-md-6 col-sm-12 left-column">
                        <div className="left-content">
                          <h3>
                            Morente reiterates rule on proper wearing of uniform
                          </h3>
                          <p>
                            In a memorandum issued on Wednesday, Morente stated
                            that the BI has been receiving complaints about
                            officials and employees who are not wearing their
                            complete uniform during their tour of duty.
                          </p>
                          <p>
                            Stands for courtesy, accountability, responsibility,
                            efficiency and service. “It is high time that law
                            enforcement be professionalized,” said Morente. “We
                            can implement our laws and policies, but as public
                            servants, we are also expected to be courteous and
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-12 right-column">
                        <div className="right-content">
                          ...
                          <ul className="list-item clearfix">
                            <li>
                              <Link href="visa-details">
                                1. Attending business meetings or consultations{" "}
                                <i className="icon-9"></i>
                              </Link>
                            </li>
                            <li>
                              <Link href="visa-details">
                                2. Attending a business convention or conference{" "}
                                <i className="icon-9"></i>
                              </Link>
                            </li>
                            <li>
                    ...
                    <div className="row clearfix">
                      <div className="col-lg-4 col-md-6 col-sm-12 single-column">
                        <div className="single-item">
                          <figure className="image-box">
                            <img
                              src="assets/images/resource/visa-13.jpg"
                              alt=""
                            />
                          </figure>
                          <div className="lower-content">
                            ...
                            <ul className="list-item clearfix">
                              <li>
                                <Link href="visa-details">1. Overview</Link>
                              </li>
                              <li>
                                <Link href="visa-details">2. How to Apply</Link>
                              </li>
                              <li>
                                <Link href="visa-details">3. Fees</Link>
                              </li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 single-column">
                        <div className="single-item">
                          <figure className="image-box">
                            <img
                              src="assets/images/resource/visa-14.jpg"
                              alt=""
                            />
                          </figure>
                          <div className="lower-content">
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 single-column">
                        <div className="single-item">
                          <figure className="image-box">
                            <img
                              src="assets/images/resource/visa-15.jpg"
                              alt=""
                            />
                          </figure>
                          <div className="lower-content">

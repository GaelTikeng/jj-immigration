                ...
                <div className="blog-details-content">
                  <div className="content-one mb_40">
                    ...
                    <ul className="post-info clearfix">
                      ...
                      <li>
                        <i className="icon-56"></i>Feb 6, 2022{" "}
                      </li>
                      <li>
                        <i className="icon-57"></i>
                        <Link href="blog-details">03 Comments</Link>
                      </li>
                    </ul>
                    <div className="text">
                      <p>
                        ...
                        feugiat diam laoreet eget. Vivamus venenatis turpis
                        lacinia, congue massa in, accumsan orci. Vestibulum ante
                        ipsum primis in faucibus orci luctus et ultrices posuere
                        cubilia curae; Quisque vestibulum id risus sit amet
                        faucibus. Vestibulum sodales lacus eros, sed maximus
                        sapien mollis ultrices. In odio mi, scelerisque a libero
                        et, pulvinar pulvinar enim. Etiam at volutpat augue, eu
                        hendrerit nunc. Sed eleifend risus diam, quis iaculis
                        elit imperdiet sit amet. Suspendisse scelerisque eros
                        odio, sed malesuada felis semper eu. Fusce laoreet justo
                        ac risus feugiat venenatis. Curabitur imperdiet
                        efficitur feugiat. Curabitur lacinia rhoncus sapien sit
                        amet pulvinar. Pellentesque habitant morbi tristique
                        senectus et netus et malesuada fames ac turpis egestas.
                        Quisque ut velit ut enim porta pellentesque vel vel ex.
                        Pellentesque sollicitudin ac tortor vel euismod.
                      </p>
                      <p>
                        Donec eu volutpat dolor. Ut aliquam nisi tincidunt urna
                        sollicitudin ornare. Etiam sagittis faucibus eros
                        imperdiet tincidunt. Sed interdum posuere gravida. Sed
                        at aliquet sapien. nec, auctor in odio.
                      </p>
                      ...
                      <p>
                        ...
                        faucibus. Vestibulum sodales lacus eros, sed maximus
                        sapien mollis ultrices. In odio mi, scelerisque a libero
                        et, pulvinar pulvinar enim. .{" "}
                      </p>
                      <ul className="list-item clearfix">
                        <li>
                          Phasellus tempor sapien eu velit porta egestas posuere
                          a turpis.
                        </li>
                        <li>
                          Aliquam blandit tellus lobortis mollis faucibus.
                        </li>
                        <li>
                          Integer mollis sapien vitae magna pellentesque, in
                          placerat odio tempor.
                        </li>
                        <li>
                          Etiam dignissim turpis a lorem finibus pellentesque.
                        </li>
                        <li>
                          Aenean convallis leo et magna egestas, ut tincidunt
                          nunc suscipit.
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="comments-box mb_60">
                    ...
                    <div className="comment-inner">
                      <div className="comment">
                        ...
                        <h5>
                          Farrel Collins <span>March 19, 2022</span>
                        </h5>
                        <p>
                          Vivamus ac ultricies ex. Donec lacinia lacus libero,
                          sed feugiat diam laoreet eget. Vivamus venenatis
                          turpis lacinia, congue massa in, accumsan orci.
                          Vestibulum ante ipsum primis in faucibus orci luctus
                          et ultrices posuere cubilia curae; Quisque vestibulum
                          id risus sit amet faucibus.{" "}
                        </p>
                      ...
                      <div className="comment replay-comment">
                        ...
                        <h5>
                          Haris Gulati <span>March 19, 2022</span>
                        </h5>
                        <p>
                          Vivamus ac ultricies ex. Donec lacinia lacus libero,
                          sed feugiat diam laoreet eget. Vivamus venenatis
                  ...
                  <div className="sidebar-widget category-widget">
                    ...
                    <div className="widget-content">
                      <ul className="category-list-two clearfix">
                        <li>
                          <Link href="blog-details">Immigration</Link>
                        </li>
                        <li>
                          <Link href="blog-details">Application</Link>
                        </li>
                        <li>
                          <Link href="blog-details">Business Visa</Link>
                        </li>
                        <li>
                          <Link href="blog-details">Spouse/Family Visas</Link>
                        </li>
                        <li>
                          <Link href="blog-details">Working Visas</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="sidebar-widget post-widget">
                    ...
                    <div className="post-inner">
                      <div className="post">
                        ...
                        <h5>
                          <Link href="blog-details">
                            Kickstart Your Visa ApprovalWith 4 Easy Steps
                          </Link>
                        </h5>
                      ...
                      <div className="post">
                        ...
                        <h5>
                          <Link href="blog-details">
                            Customers Applying for Priority Visas.
                          </Link>
                        </h5>
                    ...
                    <div className="widget-content p_relative">
                      <ul className="image-list clearfix">
                        ...
                        <li>
                          <figure className="image-box">
                            <Link
                              href="assets/images/news/gallery-7.jpg"
                              className="lightbox-image"
                              data-fancybox="gallery"
                            >
                              <img
                                src="assets/images/news/gallery-7.jpg"
                                alt=""
                              />
                            </Link>
                          </figure>
                        ...
                        <li>
                          <figure className="image-box">
                            <Link
                              href="assets/images/news/gallery-8.jpg"
                              className="lightbox-image"
                              data-fancybox="gallery"
                            >
                              <img
                                src="assets/images/news/gallery-8.jpg"
                                alt=""
                              />
                            </Link>
                          </figure>
                  ...
                  <div className="sidebar-widget tags-widget">
                    ...
                    <div className="widget-content">
                      <ul className="tags-list clearfix">
                        <li>
                          <Link href="blog-details"># Agents</Link>
                        </li>
                        <li>
                          <Link href="blog-details"># Business</Link>
                        </li>

                  ...
                  <div className="content-box p_relative d_block">
                    ...
                    <div className="text mb_25">
                      <p>
                        ...
                        praising happiness come from? Explain to me how this
                        erroneous theory ended up being devised.
                      </p>
                    </div>
          ...
          <div className="auto-container">
            <div className="title-box mb_70">
              ...
              <div className="text">
                <p>
                  Where did this incorrect belief that everyone dislikes
                  praising happiness come from? Explain to me how this erroneous
                  theory ended up being devised.
                </p>
              </div>
            </div>
            <div className="row clearfix">
                ...
                <div className="coaching-block-one">
                  <div className="inner-box">
                    <div className="image-box clearfix">
                      <figure className="image">
                        <img
                          src="assets/images/resource/coaching-1.jpg"
                          alt=""
                        />
                      </figure>
                      <figure className="image">
                        <img
                          src="assets/images/resource/coaching-2.jpg"
                          alt=""
                        />
                      </figure>
                    </div>
                    <div className="lower-content">
                      <h3>
                        <Link href="coaching-details-3">Get Coaching</Link>
                      </h3>
                      <p>
                        Sed gravida nisl a porta tincidunt. Integer aliquam nisi
                        sit amet magna suscipit, fermentum.
                      </p>
                ...
                <div className="coaching-block-one">
                  <div className="inner-box">
                    <div className="image-box clearfix">
                      <figure className="image">
                        <img
                          src="assets/images/resource/coaching-3.jpg"
                          alt=""
                        />
                      </figure>
                      <figure className="image">
                        <img
                          src="assets/images/resource/coaching-4.jpg"
                          alt=""
                        />
                      </figure>
                    </div>
                ...
                <div className="coaching-block-one">
                  <div className="inner-box">
                    <div className="image-box clearfix">
                      <figure className="image">
                        <img
                          src="assets/images/resource/coaching-5.jpg"
                          alt=""
                        />
                      </figure>
                      <figure className="image">
                        <img
                          src="assets/images/resource/coaching-6.jpg"
                          alt=""
                        />
                      </figure>
                    </div>
                    <div className="lower-content">
                      <h3>
                        <Link href="coaching-details">Tofel Coaching</Link>
                      </h3>
                      <p>
                        Sed gravida nisl a porta tincidunt. Integer aliquam nisi
                        sit amet magna suscipit, fermentum.
          ...
          <div className="outer-container clearfix">
              ...
              <div className="inner-box">
                <div className="static-content">
                  <figure className="image-box">
                    <img src="assets/images/resource/coaching-7.jpg" alt="" />
                  </figure>
                  <div className="content-box">
                    ...
                    <h3>
                      <Link href="coaching-details">TOEFL Coaching</Link>
                    </h3>
                    <p>
                      Equaly blame belongs those fail their all duty through
                      weak shrinking.
                    </p>
                  </div>
                </div>
                <div className="overlay-content">
                  ...
                  <div className="content-box">
                    ...
                    <p>
                      ...
                      lacinia, congue massa in, accumsan orci.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="coaching-block-three">
              <div className="inner-box">
                <div className="static-content">
                  <figure className="image-box">
                    <img src="assets/images/resource/coaching-8.jpg" alt="" />
                  </figure>
                  <div className="content-box">
                    <div className="icon-box">
                    ...
                    <h3>
                      <Link href="coaching-details">Graduate Re-Exam</Link>
                    </h3>
                    <p>
                      Equaly blame belongs those fail their all duty through
                      weak shrinking.
            ...
            <div className="coaching-block-three">
              <div className="inner-box">
                <div className="static-content">
                  <figure className="image-box">
                    <img src="assets/images/resource/coaching-9.jpg" alt="" />
                  </figure>
                  <div className="content-box">
                    <div className="icon-box">
                    ...
                    <h3>
                      <Link href="coaching-details">Scholastic Apti</Link>
                    </h3>
                    <p>
                      Equaly blame belongs those fail their all duty through
                      weak shrinking.
            ...
            <div className="coaching-block-three">
              <div className="inner-box">
                <div className="static-content">
                  <figure className="image-box">
                    <img src="assets/images/resource/coaching-10.jpg" alt="" />
                  </figure>
                  <div className="content-box">
                    <div className="icon-box">
                    ...
                    <h3>
                      <Link href="coaching-details">Management Test</Link>
                    </h3>
                    <p>
                      Equaly blame belongs those fail their all duty through
                      weak shrinking.
